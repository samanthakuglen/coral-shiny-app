    ...
    navbarMenu("About",
               ...
               tabPanel("The Data",
                        fluidRow(
                          column(
                            width = 12,
                            h2("Data Subset and Wrangling"),
                            p("Data used here were subset and wrangled into a daily average data frame. It is important to explore your data prior to analyzing it. One way that this can be accomplished is through exploratory data visualization like histograms and box plots. By exploring data this way, we can make decisions on what type of analysis approaches are appropriate for the data.")
                          )
                        ),
                        sidebarLayout(
                          sidebarPanel(
                            checkboxGroupInput(
                              ...
                              choiceValues = c(
                                "ABUR", "AHND", "AQUE", "BULL", "CARP",
                                "GOLB", "IVEE", "MOHK", "NAPL", "SCDI", "SCTW"
                              ),
                              choiceNames = c(
                                "Arroyo Burro", "Arroyo Hondo", "Arroyo Quemado", "Bulito", "Carpinteria",
                                "Goleta Bay", "Isla Vista", "Mohawk", "Naples", "Santa Cruz Island, Diablo", "Santa Cruz Island, Twin Harbor"
                              ),
                              selected = "ABUR"
                            )
                          ),
